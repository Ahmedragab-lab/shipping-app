...
@include('partial.error')
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0"> {{ __('Edit tracking_steps page') }}</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('tracking_steps.index') }}" class="default-color">Edit tracking_steps</a></li>
   ...
   <div class="card">
       ...
       <div class="card-body">
         <form action="tracking_steps/update" method="post" autocomplete="off" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
            <div class="row">
