               ...
               <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="column is-4" data-aos="fade">
                        ...
                        <div class="work-item-meta">
                            <h3>
                            <a href="<?php echo e(route('front.show',$product->id)); ?>"><?php echo e($product->product_name); ?></a>
                            </h3>
                            <h5>
                            <a href="#"><?php echo e($product->selling_price); ?> LE</a>
                            </h5>
                    ...
                    <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class=" item" >
                            ...
                            <figure class="post-image">
                                <a href="<?php echo e(route('allproducts.show',$cat->id)); ?>">
                                <img alt="Joo - Niche Multi-Purpose HTML Template" src="<?php echo e(asset('uploads/cat/'. $cat->image)); ?>"> </a>
                            </figure>
                            <div class="entry-header">
                                <h2 class="entry-title">
                                <a href="#"><?php echo e($cat->cat_name); ?></a>
                                </h2>
...
<?php echo $__env->make('front.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shipping-app\resources\views/allproducts.blade.php ENDPATH**/ ?>