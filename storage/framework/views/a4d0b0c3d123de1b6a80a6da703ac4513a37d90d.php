...
<?php $__env->startSection('navbar-slider'); ?>
        ...
        <section class="hero slider is-clearfix ">
          ...
          <div class="rev_slider_wrapper fullscreen-container ">
            <div id="rev_slider_1" class="rev_slider tp-overflow-hidden fullscreenbanner" data-version="5.4.7" style="display:none">
              ...
              <ul>
                <li data-transition="fade" data-thumb="<?php echo e(asset('front/images/icons/1.png')); ?>" data-title="warehousing" data-param1="Lorem ipsum dolor sit ultrices eleifend gravi." data-param2="<?php echo e(asset('front/images/icons/1.png')); ?>">
                    <img alt="Joo - Niche Multi-Purpose HTML Template" class="rev-slidebg" src="<?php echo e(asset('front/images/slider/4.png')); ?>" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-kenburns="off" data-duration="30000" data-ease="Linear.easeNone"
                  ...
                  <!-- slide -->
                  <li data-transition="fade" data-thumb="<?php echo e(asset('front/images/icons/2.png')); ?>" data-title="air freight" data-param1="Lorem ipsum dolor sit ultrices eleifend gravi." data-param2="<?php echo e(asset('front/images/icons/2.png')); ?>">
                    <img alt="Joo - Niche Multi-Purpose HTML Template" class="rev-slidebg" src="<?php echo e(asset('front/images/slider/3.png')); ?>" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-kenburns="off" data-duration="30000" data-ease="Linear.easeNone"
                      data-scalestart="100" data-scaleend="115" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="15">
                    <div class="tp-caption tp-resizeme small_text top" data-x="left" data-hoffset="['-105','-105','0','0']" data-y="center" data-voffset="['-152','-152','-152','-152']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="text"
                      data-responsive-offset="on" data-frames='[{"from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","speed":1600,"to":"o:1;","delay":800,"ease":"Power3.easeInOut"},{"delay":"wait","speed":1000,"to":"opacity:0;","ease":"nothing"}]'
                      data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"> logistics cargo </div>
                  ...
                  <!-- slide -->
                  <li data-transition="fade" data-thumb="<?php echo e(asset('front/images/icons/3.png')); ?>" data-title="ocean freight" data-param1="Lorem ipsum dolor sit ultrices eleifend gravi." data-param2="<?php echo e(asset('front/images/icons/3.png')); ?>">
                    <img alt="Joo - Niche Multi-Purpose HTML Template" class="rev-slidebg" src="<?php echo e(asset('front/images/slider/2.png')); ?>" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-kenburns="off" data-duration="30000" data-ease="Linear.easeNone"
                      data-scalestart="100" data-scaleend="115" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="15">
                    <div class="tp-caption tp-resizeme small_text top" data-x="left" data-hoffset="['-105','-105','0','0']" data-y="center" data-voffset="['-152','-152','-152','-152']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="text"
                      data-responsive-offset="on" data-frames='[{"from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","speed":1600,"to":"o:1;","delay":800,"ease":"Power3.easeInOut"},{"delay":"wait","speed":1000,"to":"opacity:0;","ease":"nothing"}]'
                      data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"> logistics cargo </div>
                  ...
                  <!-- slide -->
                  <li data-transition="fade" data-thumb="<?php echo e(asset('front/images/icons/4.png')); ?>" data-title="land transport" data-param1="Lorem ipsum dolor sit ultrices eleifend gravi." data-param2="<?php echo e(asset('front/images/icons/4.png')); ?>">
                    <img alt="Joo - Niche Multi-Purpose HTML Template" class="rev-slidebg" src="<?php echo e(asset('front/images/slider/1.png')); ?>" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-kenburns="off" data-duration="30000" data-ease="Linear.easeNone"
                      data-scalestart="100" data-scaleend="115" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="15">
                    <div class="tp-caption tp-resizeme small_text top" data-x="left" data-hoffset="['-105','-105','0','0']" data-y="center" data-voffset="['-152','-152','-152','-152']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="text"
                      data-responsive-offset="on" data-frames='[{"from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","speed":1600,"to":"o:1;","delay":800,"ease":"Power3.easeInOut"},{"delay":"wait","speed":1000,"to":"opacity:0;","ease":"nothing"}]'
                      data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"> logistics cargo </div>
            ...
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class=" item" >
                    ...
                    <figure class="post-image">
                        <a href="<?php echo e(route('front.show',$product->id)); ?>">
                        <img alt="Joo - Niche Multi-Purpose HTML Template" src="<?php echo e(asset('uploads/product/'. $product->image)); ?>"> </a>
                    </figure>
                    <div class="entry-header">
                        <h2 class="entry-title">
                        <a href="#"><?php echo e($product->product_name); ?></a>
                        </h2>
                        <span class="float-start entry-title"><?php echo e($product->selling_price); ?></span>
                        <span class="float-end "><s><?php echo e($product->original_price); ?></s></span>
                    </div>
                    <!-- .entry-header -->
                    ...
                    <div class="entry-footer">
                        <a href="<?php echo e(route('front.show',$product->id)); ?>" class="button">More details</a>
                    </div>
                    </article>
                    <!-- .blog-post -->
                </div>
            ...
            <?php $__currentLoopData = $servs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="column is-4" >
                    ...
                    <a href="#">
                        ...
                        <img alt="no photo" src="<?php echo e(asset('uploads/serv/'.$serv->image)); ?>" style="max-height: 344px ;">
                    </a>
                    <h3>
                        <a href="#"><?php echo e($serv->serve_name); ?></a>
                    </h3>
                    <p><?php echo e($serv->desc); ?></p>
                    <p><?php echo e($serv->status == 1 ?'Available':'Unavialable'); ?></p>
                    <a href="<?php echo e(route('order')); ?>" class="button"> Make Order</a>
                    </div>
                    <!-- .box-item -->
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="column is-6-desktop is-12-tablet" data-aos="fade">
          ...
          <div class="level">
            ...
            <div class="level-right">
              <img alt="Joo - Niche Multi-Purpose HTML Template" src="<?php echo e(asset('front/images/global/mark.png')); ?>"> </div>
          </div>
        </div>
      </div>
      <br> </div>
...
<?php echo $__env->make('front.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shipping-app\resources\views/welcome.blade.php ENDPATH**/ ?>