            ...
            <div class="nav-wrap">
              <nav class="main-navigation right">
                <ul class="menu">
                  ...
                  <li>
                    <a href="<?php echo e(route('allproducts.index')); ?>">Product</a>
                  </li>
                  <li>
                  ...
                  <?php if(auth()->guard()->check()): ?>
                    <li class="has-dropdown">
                        <a href="#"><?php echo e(\Str::limit(auth()->user()->name, 10)); ?></a>
                        <ul class="dropdown">
                            <li><a href="#">Profile</a></li>
                            <?php if(auth()->user()->roles_name==["Owner"]): ?>
                            
                            <li><a href="<?php echo e(route('home')); ?>">My Dashboard</a></li>
                            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\shipping-app\resources\views/front/layout/navbar.blade.php ENDPATH**/ ?>