                ...
                <nav class="clients-list level  owl-carousel no-dots carousel-items-5">
                  <div class="client-item has-text-centered level-item">
                    <a href="#" target="_blank">
                      <img alt="Joo - Niche Multi-Purpose HTML Template" src="<?php echo e(asset('front/images/clients/7.png')); ?>"> </a>
                  </div>
                  <div class="client-item has-text-centered level-item">
                    <a href="#" target="_blank">
                      <img alt="Joo - Niche Multi-Purpose HTML Template" src="<?php echo e(asset('front/images/clients/8.png')); ?>"> </a>
                  </div>
                  <div class="client-item has-text-centered level-item">
                    <a href="#" target="_blank">
                      <img alt="Joo - Niche Multi-Purpose HTML Template" src="<?php echo e(asset('front/images/clients/9.png')); ?>"> </a>
                  </div>
                  <div class="client-item has-text-centered level-item">
                    <a href="#" target="_blank">
                      <img alt="Joo - Niche Multi-Purpose HTML Template" src="<?php echo e(asset('front/images/clients/7.png')); ?>"> </a>
            ...
            <div class="widget widget-html">
              <div class="textwidget">
                <div id="footer-logo" class="site-logo ">
                  <a href="./index.html">
                    <img alt="Joo - Niche Multi-Purpose HTML Template" src="<?php echo e(asset('front/images/logo/logo2.png')); ?>">
                ...
                <div class="nav-wrap">
                  <nav class="main-navigation right">
                    <ul class="menu">
                      ...
                      <li>
                        <a href="<?php echo e(route('allproducts.index')); ?>">All Products</a>
                      </li>
                      <li>
                        <a href="<?php echo e(route('order')); ?>">services</a>
                      </li>
                      <li>
...
<?php /**PATH C:\xampp\htdocs\shipping-app\resources\views/front/layout/footer.blade.php ENDPATH**/ ?>