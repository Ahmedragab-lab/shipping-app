            ...
            <div class="columns is-multiline is-variable is-6 product_data">
              <div class="column is-6">
                <div class="flexslider thumbnails">
                  <ul class="slides">
                    <li data-thumb="<?php echo e(asset('uploads/product/' . $product->image)); ?>">
                      <img alt="Joo - Niche Multi-Purpose HTML Template" src="<?php echo e(asset('uploads/product/' . $product->image)); ?>" style="min-width: 770px;"> </li>
                    <li data-thumb="<?php echo e(asset('uploads/product/' . $product->image)); ?>">
                      <img alt="Joo - Niche Multi-Purpose HTML Template" src="<?php echo e(asset('uploads/product/' . $product->image)); ?>" style="min-width: 770px;"> </li>
                    <li data-thumb="<?php echo e(asset('uploads/product/' . $product->image)); ?>">
                      <img alt="Joo - Niche Multi-Purpose HTML Template" src="<?php echo e(asset('uploads/product/' . $product->image)); ?>" style="min-width: 770px;"> </li>
              ...
              <div class="column is-6">
                <h1 class="heading-title style-1 has-text-left"><?php echo e($product->product_name); ?></h1>
                ...
                <br>
                <p class="has-text-primary is-size-3">Original price : <s><?php echo e($product->original_price); ?> LE</s></p>
                <p class="has-text-primary is-size-1">Selling price : <?php echo e($product->selling_price); ?> LE</p>
                <br>
                <p class="has-text-primary"> Description :<?php echo e($product->small_desc); ?></p>
                <p> <?php echo $product->desc; ?></p>
                <br>
                <input type="hidden" value="<?php echo e($product->id); ?>" class="prod_id" name="prod_id">
            ...
            <div class="tabs-list ">
              ...
              <div class="tabs-content">
                <div class="tab-block content">
                  ...
                  <ul>
                    <li><?php echo e($product->meta_title); ?> </li>
                    <li> <?php echo e($product->meta_desc); ?> </li>
                    <li> <?php echo e($product->meta_keywords); ?> </li>
...
<?php echo $__env->make('front.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shipping-app\resources\views/product-details.blade.php ENDPATH**/ ?>